<html>
    <head>
        <title>Read Other Terms of Service!</title>
    ...
    <center>
        <h1>Fetch data that users have created</h1>
        <div class="container">
            <form action="" method="POST">
             
                <input type='submit' name='search' placeholder="Click here to search!"/>
                <br>
            ...
            <table>
                <tr>
                    ...
                    <th>Company Name</th>
                    <th>Terms of Service Link</th>
                    <th>Condensed Version of Terms of Service</th>
                </tr><br>
                <?php
                $connection = mysqli_connect("localhost","root","");
                $db = mysqli_select_db($connection,'tosdb');
                
                if(isset($_POST['search']))
                {
                    
                    $result=mysqli_query($connection, "SELECT * FROM `table_tos` ");
                ...
                <br>
                    ...
                    <td> <?php echo $row['toslink']; ?> </td>
                    <td> <?php echo $row['toscustomdata']; ?> </td>
                </tr>
                        <?php
                    }
                }
