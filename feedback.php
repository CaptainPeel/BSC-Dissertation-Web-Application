...
<html lang="en">
    ...
    <body>
        ...
        <form action="feedbackinsert1.php" method="post">
            Enter your Username: <input type="text" name="username"><br>
            Enter your email: <input type="text" name="email"><br>
            <br>

            Leave a review: <textarea name="inputtedtext" cols="40" rows="5"></textarea>

            <input type="submit">
        </form>

        <a href=http://localhost/ReadUserFeedback.php onclick="basicPopup3(this.href);
                                return false">Read Data History</a>
        <script>
    ...
    toolbar=yes,menubar=no,location=no,directories=no, status=yes')
        ...
        <a href=http://localhost/welcome.php onclick="basicPopup3(this.href);
                 return false">Return home</a>
        <script>
                    // JavaScript popup window function
                    function basicPopup3(url) {
                        popupWindow = window.open(url, 'popUpWindow', 'height=420,width=470,left=50,top=50,resizable=yes,scrollbars=yes,\n\
